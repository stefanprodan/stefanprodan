---
title:  "How to secure OpenFaaS with Let's Encrypt and basic auth on Google Kubernetes Engine"
description: "Setting up HTTPS Load Balancing and basic-auth with Kubernetes Ingress for OpenFaaS Gateway on GKE"
date:   2017-12-04 08:00:00
categories: [Open Source]
tags: [OpenFaaS,Kubernetes]
---

This is a step by step guide on setting up HTTPS load balancing and basic-auth with Kubernetes Ingress 
for OpenFaaS Gateway on GKE.

![ingress-tls](https://raw.githubusercontent.com/stefanprodan/openfaas-gke/master/screens/ingress-tls.png)
...
This will create the pods, deployments and services for the OpenFaaS gateway, faas-netesd (K8S controller), 
...
If you have any suggestion on improving this guide please submit an issue or PR on GitHub at [stefanprodan/openfaas-gke](https://github.com/stefanprodan/openfaas-gke). 
