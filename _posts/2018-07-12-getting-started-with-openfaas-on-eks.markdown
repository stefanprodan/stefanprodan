---
title:  "Getting started with OpenFaaS on EKS"
description: "OpenFaaS operator instalation guide for Amazon's managed Kubernetes service"
date:   2018-07-12 00:00:00
categories: [Open Source]
tags: [OpenFaaS, Kubernetes]
canonical_url: https://www.weave.works/blog/getting-started-with-openfaas-kubernetes-operator-on-eks
---

The [OpenFaaS](https://openfaas.com) team recently released a Kubernetes operator for OpenFaaS. The OpenFaaS Operator can be run with OpenFaaS on any Kubernetes service, 
in this post I will show you step-by-step instructions on how to deploy to Amazon's managed Kubernetes service (EKS).

The [OpenFaaS Operator](https://github.com/openfaas-incubator/openfaas-operator) comes with an extension to the Kubernetes API that allows you to manage OpenFaaS functions
...
![openfaas-operator](https://raw.githubusercontent.com/stefanprodan/openfaas-flux/master/docs/screens/openfaas-operator.png)
...
Running OpenFaaS on EKS and [Weave Cloud](https://www.weave.works/blog/getting-started-with-openfaas-kubernetes-operator-on-eks) you get a production ready function-as-a-service platform with builtin continuous deployment, monitoring and alerting.
